  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        ...
        highlightColor: Colors.transparent, // ปิด highlight
        splashColor: Colors.transparent, // ปิด splash
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: Technician_menu(
...
class Technician_menu extends StatelessWidget {
