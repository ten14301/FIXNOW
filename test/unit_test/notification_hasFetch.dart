import 'package:fixnow/notification_hasFetch.dart';
...
void main() {
  ...
  group('NotificationHasProvider', () {
    late NotificationHasProvider provider;
    ...
    setUp(() async {
      ...
      // สร้าง instance ของ NotificationHasProvider และโหลดค่าจาก SharedPreferences
      provider = NotificationHasProvider();
